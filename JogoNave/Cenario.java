...
public class Cenario {
    ...
    public Cenario(Nave umaNave, Inimigo umInimigo, Placar umPlacar) {                      
        ...
        janela.setTitle("Aula Pratica POO: Jogo da Nave");
        ...
        try {
            ...
            imgNave = ImageIO.read(new File("nave.png"));
            imgInimigo = ImageIO.read(new File("inimigo.png"));
            imgMisselNave = ImageIO.read(new File("misselNave.png"));
            imgMisselInimigo = ImageIO.read(new File("misselInimigo.png"));
            imgExplosao = ImageIO.read(new File("explosao.png"));
    ...
    private class PainelDeDesenho extends JPanel {                    
        ...
        private void desenharMensagensGerais(Graphics g) {
            ...
            g.setColor(Color.GRAY);
            g.drawString("GCC110 (POO) - DCC/UFLA", (int)getSize().getWidth()-200, (int)getSize().getHeight()-15);
        }
    ...
    private class InputHandler implements KeyListener {
         ...
         */       
        public boolean teclaEstaPressionada(int keyCode) {
         ...
         */
        void tratarTeclasControle(int keyCode) {
