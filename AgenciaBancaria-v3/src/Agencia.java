...
public class Agencia {
    ...
    // utilizado para gerar números de conta
    private static int proximoNroConta;
    ...
    public int criarConta() {
        contas.put(proximoNroConta, new Conta(proximoNroConta));
        proximoNroConta++;

        return proximoNroConta-1;
    }
    ...
    public boolean transferir(int nroContaOrigem, int nroContaDestino, double valor) {
        ...
        // Busca as contas de origem e destino e, se existirem, faz a transferência
